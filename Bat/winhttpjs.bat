...
function parseArgs() {
    ...
    // !!! 
    url = "https://www.falabella.com/rest/model/falabella/rest/browse/BrowseActor/get-product-record-list?%7b%22navState%22%3a%22%2fsearch%2f%3fNtt%3d"+ARGS.Item(1)+"%22%7d";
    // !!! 
    if (ARGS.Length % 2 != 0) {
